...
Usage:
  sonar2elastic.py --sonarApiUrl="http://10.0.0.1:30310/sonar/api" --elasticApiUrl="10.0.0.2" --elasticApiPort=9000 --idReg=26 --indexName="sonarqube" --pipeline="MyJob" --pipelineDescription="MyJobData" --sonarProjectKey="br.com.teste.app:server" 
  sonar2elastic.py -h
